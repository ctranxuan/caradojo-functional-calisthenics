 ...
 * @author ctranxuan
 */
@DisplayName("MapAnswerToPlayer should")
class MapAnswerToPlayerShould {

    private MapAnswerToPlayer mapAnswerToPlayer = new MapAnswerToPlayer();

    @Test
    @DisplayName("return PLAYER1 when P1 is given")
    void return_PLAYER1_for_P1() {
        Player player = mapAnswerToPlayer.apply("P1");
    ...
    void return_PLAYER2_for_P2() {
        Player player = mapAnswerToPlayer.apply("P2");
    ...
    void throw_an_Exception_if_argument_is_not_P1_nor_P2() {
        Assertions.assertThrows(RuntimeException.class, () -> mapAnswerToPlayer.apply("toto"));
    }
